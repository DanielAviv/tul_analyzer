export default {
  ...
  stepsHeading: 'Steps',
  stepsEmpty: 'Step list coming soon.',
  ...
  sourceLabel: 'Source',
  dropFileHere: 'Drop video file here',
  ...
  tul: {
    ...
    'chon-ji': {
      ...
      steps: [
        'Move left foot to B into a left walking stance, executing a low block to B with the left forearm.',
        'Move right foot to B into a right walking stance, executing a middle punch to B with the right fist.',
        'Move right foot to A turning clockwise into a right walking stance, executing a low block to A with the right forearm.',
        'Move left foot to A into a left walking stance, executing a middle punch to A with the left fist.',
        'Move left foot to D into a left walking stance, executing a low block to D with the left forearm.',
        'Move right foot to D into a right walking stance, executing a middle punch to D with the right fist.',
        'Move right foot to C turning clockwise into a right walking stance, executing a low block to C with the right forearm.',
        'Move left foot to C into a left walking stance, executing a middle punch to C with the left fist.',
        'Move left foot to A into a right L-stance, executing a middle block to A with the left inner forearm.',
        'Move right foot to A into a right walking stance, executing a middle punch to A with the right fist.',
        'Move right foot to B turning clockwise into a left L-stance, executing a middle block to B with the right inner forearm.',
        'Move left foot to B into a left walking stance, executing a middle punch to B with the left fist.',
        'Move left foot to C into a right L-stance, executing a middle block to C with the left inner forearm.',
        'Move right foot to C into a right walking stance, executing a middle punch to C with the right fist.',
        'Move right foot to D turning clockwise into a left L-stance, executing a middle block to D with the right inner forearm.',
        'Move left foot to D into a left walking stance, executing a middle punch to D with the left fist.',
        'Move right foot to D into a right walking stance, executing a middle punch to D with the right fist.',
        'Move right foot to C into a left walking stance, executing a middle punch to D with the left fist.',
        'Move left foot to C into a right walking stance, executing a middle punch to D with the right fist.',
      ],
    },
    'dan-gun': {
